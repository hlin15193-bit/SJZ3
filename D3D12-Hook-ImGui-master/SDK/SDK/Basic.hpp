...
namespace Offsets
{
	constexpr int32 GObjects          = 0x12F68B00;
	constexpr int32 AppendString      = 0x09BFB120;
	constexpr int32 GNames            = 0x00000000;
	constexpr int32 GWorld            = 0x1264B648;
	constexpr int32 ProcessEvent      = 0x09F5BEA0;
...
public:
	...
	static constexpr int32                        ElementsPerChunk = 0x16800;                        // 0x0000(0x0004)(NOT AUTO-GENERATED PROPERTY)

	int32                                         MaxChunks;                                         // 0x0000(0x0004)(NOT AUTO-GENERATED PROPERTY)
	int32                                         NumElements;                                       // 0x0004(0x0004)(NOT AUTO-GENERATED PROPERTY)
	int32                                         NumChunks;                                         // 0x0008(0x0004)(NOT AUTO-GENERATED PROPERTY)
	...
	int32                                         MaxElements;                                       // 0x0028(0x0004)(NOT AUTO-GENERATED PROPERTY)
...
//static_assert(offsetof(TUObjectArray, MaxChunks) == 0x000000, "Member 'TUObjectArray::MaxChunks' has a wrong offset!");
//static_assert(offsetof(TUObjectArray, NumElements) == 0x000004, "Member 'TUObjectArray::NumElements' has a wrong offset!");
//static_assert(offsetof(TUObjectArray, NumChunks) == 0x000008, "Member 'TUObjectArray::NumChunks' has a wrong offset!");
//static_assert(offsetof(TUObjectArray, Objects) == 0x000010, "Member 'TUObjectArray::Objects' has a wrong offset!");
//static_assert(offsetof(TUObjectArray, MaxElements) == 0x000028, "Member 'TUObjectArray::MaxElements' has a wrong offset!");
...
//static_assert(offsetof(FProperty, ArrayDim) == 0x00003C, "Member 'FProperty::ArrayDim' has a wrong offset!");
//static_assert(offsetof(FProperty, ElementSize) == 0x000040, "Member 'FProperty::ElementSize' has a wrong offset!");
//static_assert(offsetof(FProperty, PropertyFlags) == 0x000048, "Member 'FProperty::PropertyFlags' has a wrong offset!");
//static_assert(offsetof(FProperty, Offset) == 0x000054, "Member 'FProperty::Offset' has a wrong offset!");
